...
*
*/
define('APP_BASE_URL', 'http://medinaliber.larepaweb.com.ve/');
...
*/
define('APP_ENC_KEY', '2bdb6ef7dbc1a35606134c4be10c5c6d');
 ...
 */
define('APP_DB_USERNAME', 'medinaliber');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Utopia.2020');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'medinaliber');
